...
COPY . /usr/src/project-portfolio
WORKDIR /usr/src/project-portfolio
...
COPY --from=compile /usr/src/project-portfolio/target/Portfolio-Manager-0.0.1-SNAPSHOT.jar app.jar
